...
pipes.orderedVendorScripts = function() {
  return plugins.order(['Chart.js', 'angular.js']);
};
...
pipes.builtVendorStylesProd = function () {
  return gulp.src(bowerFiles('**/*.css'))
    ...
    .pipe(gulp.dest(paths.distProd + '/scss/'));
};
...
gulp.task('serve', ['clean-build-app-dev'], function() {
  browserSync.init({
    server: {
...
gulp.task('serve:prod', ['clean-build-app-prod'], function() {
